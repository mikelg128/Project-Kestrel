...
class Entity:
    ...
    # A-star algorithm copied from tutorial:
    # TODO: It's odd that this function does not appear in ai.py. Refactor?
    def move_astar(self, target, entities, game_map):  # TODO: Check the tcod functions used here
